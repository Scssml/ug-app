<template>
  <div style="width: 620px; margin: 0 0; font-size: 16px">
    ...
    >Распечатать</v-btn>
    <template v-for="(order, index) in ordersList">
      <div
        :key="index"
      >
        ...
        <ul style="box-sizing: border-box; width: inherit; padding: 0px 5px; margin-bottom: 0px;">
          <li style="display: flex; width: inherit">
            <div style="width: 130px; font-weight: 600; font-style: italic">Дата:</div>
            <div
              style="
                width: 490px;
          ...
          <li style="display: flex; width: inherit; margin-top: 10px">
            <div style="width: 130px; font-weight: 600; font-style: italic">Букеты:</div>
          </li>
        </ul>
        <table style="width: 620px; border-collapse: collapse; padding: 2px; margin-bottom: 10px">
          <tr>
        ...
        <ul style="box-sizing: border-box; width: inherit; padding: 0px 5px; margin-bottom: 0px;">
          <li style="display: flex; width: inherit">
            <div style="width: 130px; font-weight: 600; font-style: italic">Время:</div>
            <div
              style="
                width: 490px;
                word-wrap: break-word;
          ...
          <li style="display: flex; width: inherit">
            <div style="width: 130px; font-weight: 600; font-style: italic">Адрес:</div>
            <div
              style="
                width: 490px;
                word-wrap: break-word;
            ...
            >
                <span style="font-weight: 600; font-style: italic" contenteditable>
                  {{ order.orderAddress }}
                  <template v-if="order.flat">
                    , кв. {{ order.flat }}
                  </template>
                  <template v-if="order.entrance">
                    , подъезд {{ order.entrance }}
                  </template>
                  <template v-if="order.floor">
                    , этаж {{ order.floor }}
                  </template>
                </span>
            </div>
          ...
          <li style="display: flex; width: inherit">
            <div style="width: 130px; font-weight: 600; font-style: italic">Заказчик:</div>
            <div
              style="
                width: 490px;
                word-wrap: break-word;
            ...
            >
                <span style="font-weight: 600; font-style: italic" contenteditable>
                  {{ order.orderClient }} ({{ order.clientPhone }})
                </span>
            </div>
          </li>
          <li style="display: flex; width: inherit">
          ...
          <li style="display: flex; width: inherit">
            <div style="width: 130px; font-weight: 600; font-style: italic">Сумма к оплате:</div>
            <div
              style="
                width: 490px;
                word-wrap: break-word;
          ...
          <li style="display: flex; width: inherit">
            <div style="width: 130px; font-weight: 600; font-style: italic">Комментарий:</div>
            <div
              style="
                width: 490px;
                word-wrap: break-word;
          ...
          <li style="display: flex; width: inherit">
            <div style="width: 130px; font-weight: 600; font-style: italic">Курьер:</div>
            <div
              style="
                width: 490px;
                word-wrap: break-word;
            ...
            >
                <span style="font-weight: 600; font-style: italic" contenteditable>
                  <template v-if="order.orderCourier">
                    {{ order.orderCourier }}
                  </template>
                </span>
            </div>
...
export default {
  ...
  methods: {
    getItems() {
      ...
      const itemParams = {
        type: 'print/order/delivery-batch',
        props: {
          ids: this.ids,
        },
      };
